...
public class MainActivity extends AppCompatActivity implements Asynchtask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButtons[0] = findViewById(R.id.imgBtn1);
        imageButtons[1] = findViewById(R.id.imgBtn2);
        imageButtons[2] = findViewById(R.id.imgBtn3);
        imageButtons[3] = findViewById(R.id.imgBtn4);
        imageButtons[4] = findViewById(R.id.imgBtn5);
    ...
    public void processFinish(String result) throws JSONException {
        ...
        for (int i = 0; i < numItemsToShow; i++) {
            ...
            // Cargar la imagen en los ImageButtons correspondientes utilizando Picasso
            Picasso.get().load(imagenUrl).into(imageButtons[i]);
        }
    }
}
